...
<html lang = "en">
    ...
    <body>
        ...
        <section>
            ...
            <div class = "quality" id = "quality" onclick="location.href='details.html/{{ current.name | safe }}';">
            ...
            <div class = "earth_map" id = "earth_map">
                <img src = "../static/images/earth.jpg" alt="AquaEmi's logo" style = "width: 8.5vw; height: 6.4vw; cursor: pointer;" onclick = "location.href='map_earth.html';">
            </div>
        ...
        <section>
            <div class = "content">
                <div class = "forecast" id = "forecast">
                    ...
                    <button class = "week_forecast" onclick="location.href='details.html/{{ current.name | safe }}';">7 DAY FORECAST</button><br>
                ...
                <!-- <div class = "other_places" id = "other_places">
                    ...
                    <div class = "other_places_" id = "other_places_">
                        <div class = "other_places_box" id = "other_places_box" style = "margin-right: 4vw;" onclick="location.href='details.html/{{ current.name | safe }}';">
